...
1. Pour la question I avec E(0.5), identifier le paramètre d’intérêt θ et donner un estimateur θ̂.
...
2 et 3 \. Simuler N = 1000 échantillons i.i.d de loi commune Pareto P(a, α) (avec votre choix de paramètres) de taille n = 5, 30, 100 et calculer les moyennes et variances empiriques ¯Xn,i et Sn,i, i = 1, . . . ,N. Puis tracer l'histogramme des moyennes empiriques.
