...
La médiane d'une loi de cauchy est son paramètre. 
$$
F^{-1} (\frac{1}{2}) = \theta
$$
...
Nous pouvons essayer d'approximer \theta , c'est-à-dire la médiane, cela revient donc à chercher une estimation du quantile en 0.5 .
